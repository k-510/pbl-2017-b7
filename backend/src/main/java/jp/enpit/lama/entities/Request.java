...
public class Request{
	...
	public Request(int id, String shop, Object condition){
		this(id, shop);
		setCondition(condition);
	}
	
	public Request(int id, String shop, Object condition, Date due){
		this(id, shop, condition);
		this.due = due;
	}
	
	public Request(int id, String shop, Object condition, int clentID){
		this(id, shop, condition);
		setClentID(clentID);
	}
	
	public Request(int id, String shop, Object condition, int clentID, int surrogateID){
		this(id, shop, condition, clentID);
		setSurrogateID(surrogateID);
	}
	
	public Request(int id, String shop, Object condition, int clentID, int surrogateID, String status){
